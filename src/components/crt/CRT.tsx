...
const CRT = (props: CRTProps) => {
	return (
		<>
			<div id="screen">
				<div id="content" className="frame" style={{ height: "800px", filter: "url(#SphereMapTest) url(#contrast) url(#brightness) url(#colorfill)" }}>
					<div style={{ display: "none", position: "absolute", top: "-9999", zIndex: 0, visibility: "hidden" }}>
						<svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" id="svg-root" width="381" height="166" z-index="-1">
							<defs>
